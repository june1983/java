 ...
 <main>
	<div class="container-sl">
		<div class="shadow p-3 mb-5 bg-body rounded" style="width:1250px">
    		<div class="search">
     			<div class="me-2"><a href="/registerProduct">
     			...
     			<div class="me-2">
		            ...
		            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
		              <li><a class="dropdown-item" href="/admin?id=Tシャツ・カットソー">TS:Tシャツ・カットソー</a></li>
		              <li><a class="dropdown-item" href="/admin?id=スウェット">SW:スウェット</a></li>
		              <li><a class="dropdown-item" href="/admin?id=コート">CO:コート</a></li>
		              <li><a class="dropdown-item" href="/admin?id=ダウン">DC:ダウン</a></li>
		              <li><a class="dropdown-item" href="/admin?id=ニット・セーター">KN:ニット・セーター</a></li>
		              <li><a class="dropdown-item" href="/admin?id=ジーンズ・カラージーンズ">JE:ジーンズ・カラージーンズ</a></li>
		              <li><a class="dropdown-item" href="/admin?id=ハーフパンツ">HP:ハーフパンツ</a></li>
		              <li><a class="dropdown-item" href="/admin?id=帽子・キャップ・ハット">CA:帽子・キャップ・ハット</a></li>
		              <li><a class="dropdown-item" href="/admin?id=マスク">MA:マスク</a></li>
		              <li><a class="dropdown-item" href="/admin?id=バッグ">BA:バッグ</a></li>
		            </ul>
          		</div>
		    ...
		    <table id="foo-table" class="table table-bordered">
		    	<thead>
			        <tr>
						...
						<th scope="col" class="example5">商品説明</th>
				...
				<tbody>
					...
					<tr>
					  ...
					  <td class="example5"><%=sku.getDescription()%></td>
					  <td class="example5"><%=sku.getAttribute()%></td>
					  <td class="example1"><%=sku.getStock()%></td>
					  <td class="hensyubutton"><a href="/productEdit?id=<%=sku.getSkuId()%>"><button type="button" class="btn btn-primary btn-sm">編集する</button></a></td>
					</tr>
					<% } %>
				</tbody>
		    </table>
