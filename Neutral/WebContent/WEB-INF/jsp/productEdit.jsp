...
<div class="b-example-divider bg-info">
  <div class="row align-items-center">
    ...
    <div class="col">
      <p class="title2">管理画面／商品情報編集ページ</p>
    </div>
    <div class="col">
...
<div class="input-group flex-nowrap">
  ...
  <button type="button" class="btn btn-primary">変更する</button>
  <button type="button" class="btn btn-outline-danger">商品情報を削除する</button><br>       
  </div>  
</div>
